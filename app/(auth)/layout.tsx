  ...
  return (
    <main className="auth-layout">
        ...
        <section className="auth-right-section">
            <div className="z-10 relative lg:mt-5 lg:mb-16">
                ...
                <div className="flex item-center justify-between">
                    <div>
                        <cite className="auth-testimonial-author">-0xxghost</cite>
                        <p className="max-md:text-xs text-gray-500">Retail Investor</p>
                    </div>
                   <div className="flex item-center gap-0.5">
                    {[1, 2, 3, 4, 5].map((star) => (
                        <Image src="/assets/icons/star.svg" alt="Star"  key={star}width={16} height={16} className="w-5 h-5" />
                    ))}
                </div>
                </div>
            </div>
